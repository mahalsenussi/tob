...
<body>
    <div class="container">
        ...
        if (isset($_POST['addItem'])) {
            ...
            $itemCategory = $_POST['itemCategory']; // Get the selected category
            ...
            // Attempt to upload the image and insert into the database
            if ($uploadOk === 1) {
                if (move_uploaded_file($_FILES['itemImage']['tmp_name'], $targetFile)) {
                    // Prepare the insert statement, including the category
